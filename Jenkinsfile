node {
	...
	try {
	    ...
	    stage('Build Docker Image') {
	    		sh 'docker build -t idexceldemo/admin-service:${BUILD_NUMBER}  -f Dockerfile .'
	    		sh 'docker tag idexceldemo/admin-service:${BUILD_NUMBER} idexceldemo/admin-service:latest' 
	    }
